...
BEGIN
    ...
    GROUP BY p.name, p.displayname, p.description, p.time, p.maintainers, p.type, p.repository, p.github_stars, p.github_watchers, p.github_forks, p.github_open_issues, p.language, p.dependents, p.suggesters, p.downloads, p.favers;
