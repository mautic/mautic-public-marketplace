...
CREATE INDEX IF NOT EXISTS packages_auth0_user_id_idx ON packages(auth0_user_id);

DROP FUNCTION IF EXISTS get_view(INT, INT, TEXT, TEXT, TEXT, TEXT[], TEXT, TEXT[], INT, BOOLEAN, TEXT, TEXT, TEXT);
DROP FUNCTION IF EXISTS get_view(INT, INT, TEXT, TEXT, TEXT, TEXT[], TEXT, TEXT[], INT, BOOLEAN, TEXT, TEXT, TEXT, TEXT);
DROP FUNCTION IF EXISTS get_available_languages(TEXT, TEXT[], TEXT, INT, BOOLEAN, TEXT, TEXT, TEXT);
DROP FUNCTION IF EXISTS get_available_languages(TEXT, TEXT[], TEXT, INT, BOOLEAN, TEXT, TEXT, TEXT, TEXT);
...
BEGIN
    ...
    EXECUTE format(
        'SELECT COUNT(DISTINCT p.name)
         ...
         WHERE p.latest_mautic_support = TRUE
           ...
           ' || date_filter,
        _query, _query, _query, _type, _type, _smv, _smv, _language, _language, _minimum_rating, _minimum_rating, _minimum_rating, _unrated_only, _rated_by, _rated_by, _submitted_by, _submitted_by
    ) INTO total;
    ...
    sql_query := format(
        ...
        _query, _query, _query, _type, _type, _smv, _smv, _language, _language, _minimum_rating, _minimum_rating, _minimum_rating, _unrated_only, _rated_by, _rated_by, _submitted_by, _submitted_by, _orderby, _orderdir, _limit, _offset
    );
...
BEGIN
    ...
    EXECUTE format(
        ...
        _query, _query, _query, _type, _type, _smv, _smv, _minimum_rating, _minimum_rating, _minimum_rating, _unrated_only, _rated_by, _rated_by, _submitted_by, _submitted_by
    ) INTO languages;
